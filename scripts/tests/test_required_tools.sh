...
assert_contains "$output" "skip: managed git config not selected"
assert_contains "$output" "skip: git setup not selected"
...
assert_contains "$output" "dotfiles/.config/ghostty/config -> $home_dir/.config/ghostty/config"
assert_contains "$output" "dotfiles/.config/ghostty/config -> $home_dir/Library/Application Support/com.mitchellh.ghostty/config"
assert_contains "$output" "dry-run: touch $home_dir/.zsh_history"
...
assert_absent "$linux_apply_home/.gitconfig"
assert_file "$linux_apply_home/.ssh/config"
assert_file "$linux_apply_home/.config/ghostty/config"
assert_file "$linux_apply_home/.zsh_history"
...
assert_contains "$root_interactive_output" "BOOTSTRAP_ASSUME_TTY=1 /bin/sh '/home/dev/.local/share/dotfiles-bootstrap/repo/scripts/required_tools.sh' --dry-run"
...
assert_file "$apply_home/.config/ghostty/config"
assert_file "$apply_home/Library/Application Support/com.mitchellh.ghostty/config"
assert_file "$apply_home/.zsh_history"
...
assert_symlink_target "$link_home/.config/ghostty/config" "$REPO_ROOT/dotfiles/.config/ghostty/config"
assert_symlink_target "$link_home/Library/Application Support/com.mitchellh.ghostty/config" "$REPO_ROOT/dotfiles/.config/ghostty/config"
assert_file "$link_home/.zsh_history"
assert_absent "$link_home/.gitconfig"
